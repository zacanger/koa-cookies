    ...
    return function (ctx, next) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ctx.cookies.set(encodeURIComponent(name), encodeURIComponent(value), Object.assign({}, getDefaultSetConfig(ctx), config));
                        return [4 /*yield*/, next()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
...
var clearCookie = function (name, config) {
    if (config === void 0) { config = {}; }
    return function (ctx, next) {
        if (next === void 0) { next = defaultNext; }
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ctx.cookies.set(encodeURIComponent(name), 'removed', Object.assign({}, getDefaultClearConfig(ctx), config));
                        return [4 /*yield*/, next()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
